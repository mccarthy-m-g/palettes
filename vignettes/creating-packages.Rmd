...
sunset_palettes_discrete <- pal_palette(
  pastel = c("#FAB39F", "#6A94C0", "#FFE295", "#A9E6D3"),
  pastel_dark = c("#dc8951", "#4E8AC9", "#F5D06D", "#69ca97", "#c978b5")
)
...
sunset_palettes_sequential <- pal_palette(
  orange = pal_brewer(pal_colour(c("#dc8951", "#FBE0D1")), n = 7),
  blue   = pal_brewer(pal_colour(c("#4E8AC9", "#C1D1EB")), n = 7),
  yellow = pal_brewer(pal_colour(c("#F5D06D", "#FFECC8")), n = 7),
  green  = pal_brewer(pal_colour(c("#69ca97", "#C9EBD7")), n = 7)
)
...
We use `Depends` instead of `Imports` because sunsets is designed to be used in conjunction with palettes and is not useful without it.

This is a valid exception to the general advice to always use `Imports`. As Hadley Wickham and Jenny Bryan explain in [R Packages](https://r-pkgs.org/dependencies.html#sec-search-path): 
